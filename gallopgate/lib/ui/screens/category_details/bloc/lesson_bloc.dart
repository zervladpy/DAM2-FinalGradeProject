...
class LessonBloc extends Bloc<LessonEvent, LessonState> {
  final LessonCategoryRepository _lectureRepository;
  final ProfileRepository _profileRepository;

  LessonBloc({
    required LessonCategoryRepository lectureRepository,
  ...
  FutureOr<void> _fetch(
    ...
    try {
      final lesson = await _lectureRepository.read(event.lessonId);
