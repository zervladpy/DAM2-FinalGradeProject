...
class LessonsSliverAppbar extends StatelessWidget {
  const LessonsSliverAppbar({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return GSliverAppBar(
      ...
      actions: [
        GIconButton.filled(
          icon: Iconsax.add,
          onPressed: () => context.push('/managment/lesson-categories/create'),
        ),
      ],
      title: Column(
